...
var gameFactory = {
    createGame: function() {
        ...
        var game_board = gameFactory.createGameboard();
        gameFactory.drawBoxes(game_board);
        gameBoardLayer.add(game_board);
        gameFactory.drawGamePieces(gameBoardLayer);
    ...
    drawBoxes: function(game_board) {
        ...
        //lines are drawn.
        if(i == 2) {
            gameFactory.drawLines(game_board);
        }
        game_board.add(box);

        gameFactory.drawSpaces(game_board, box_xy_offset, box_side_length);
        }
    },

    drawLines: function(game_board) {
    ...
    drawSpaces: function(game_board, box_xy_offset, box_side_length) {
    ...
    drawGamePieces: function(gameBoardLayer) {
...
var stage = gameFactory.createGame();
